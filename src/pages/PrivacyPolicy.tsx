...
export default function PrivacyPolicy() {
  return (
    <div className="pt-32 pb-24 px-[var(--shell-padding-mobile)] md:px-[var(--shell-padding)] lg:px-[var(--shell-padding-lg)] max-w-[1000px] mx-auto text-editorial-text relative min-h-svh">
      ...
      <h1 className="font-sans font-black uppercase tracking-[-0.03em] leading-[0.85] mb-16 text-editorial-text drop-shadow-[0_10px_30px_rgba(0,0,0,0.1)] relative z-10 text-display-md">Data <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-red-600 to-red-900 drop-shadow-[0_0_30px_rgba(220,38,38,0.4)]">Security</span> <br /> Policy</h1>
