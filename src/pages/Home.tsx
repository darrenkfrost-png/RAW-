    ...
    <>
      ...
      <section className="relative z-10 border-y border-editorial-border bg-editorial-bg overflow-hidden">
        <Link to="/stay-safe" className="group block relative">
          ...
          <img
            src="/promo/assets/hero-banner-web.jpg"
            alt=""
            loading="lazy"
            aria-hidden="true"
           ...
           <div className="grid lg:grid-cols-3 gap-12">
              {[
                { 
                  ...
                  image: "/promo/assets/covered-wide-web.jpg"
                },
                { 
      ...
      <section className="py-32 xl:py-64 relative overflow-hidden text-center bg-editorial-bg border-y border-red-900/40 z-10 group/cares">
        ...
        <div className="absolute inset-0 bg-[url('/promo/assets/covered-wide-web.jpg')] bg-cover bg-center opacity-0 group-hover/cares:opacity-30 transition-opacity duration-[2000ms] mix-blend-screen pointer-events-none grayscale group-hover/cares:grayscale-[50%] transform-gpu group-hover/cares:scale-105" />
