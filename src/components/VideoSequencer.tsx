    ...
    <div className="flex-1 flex flex-col min-h-0 bg-[#050508]/90 font-sans">
      ...
      <header className="px-6 py-4 border-b border-editorial-border/30 bg-[#0e0e12] flex flex-col md:flex-row md:items-center justify-between gap-4 shrink-0">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-[8px] text-zinc-555 uppercase tracking-[0.4em] font-bold">
              AI_FILM_STUDIO // WORKSPACE_ONLINE
            </span>
            {isSaving && (
              <span className="font-mono text-[8px] text-zinc-500 bg-white/5 border border-white/15 px-2 py-0.5 rounded ml-2 uppercase animate-pulse">
                Autosaving...
              </span>
            )}
          </div>
        ...
        <div className="flex items-center gap-5">
          <div className="text-right">
            <span className="block font-mono text-[8px] text-zinc-650 uppercase tracking-widest leading-none">
        ...
        <aside className="w-full lg:w-80 border-r border-editorial-border/30 bg-zinc-950/80 p-5 overflow-y-auto custom-scrollbar flex flex-col gap-6 shrink-0">
          ...
          <div className="space-y-4">
            ...
            <form onSubmit={handleAddChar} className="space-y-2">
              <input
                ...
                className="w-full bg-[#07070a] border border-editorial-border rounded-lg px-3 py-1.5 font-mono text-[9px] text-white focus:outline-none focus:border-red-500 uppercase placeholder:text-zinc-700 font-bold"
              />
              <input
                type="text"
                ...
                className="w-full bg-[#07070a] border border-editorial-border rounded-lg px-3 py-1.5 font-mono text-[9px] text-white focus:outline-none focus:border-red-500 uppercase placeholder:text-zinc-700"
              />
              <button
                type="submit"
                className="w-full py-1.5 bg-red-650/10 hover:bg-red-600 hover:text-white border border-red-500/20 text-red-500 rounded-lg font-mono text-[9px] font-black uppercase tracking-widest transition-all"
              >
                + ADD_PROTAGONIST
              </button>
            </form>
              ...
              {characters.map(c => (
                <div key={c.id} className="p-3 bg-black/40 border border-editorial-border rounded-xl flex justify-between items-start group">
                  <div className="space-y-1">
                    <span className="block font-mono text-[9px] text-white font-bold tracking-tight">
                      {c.name}
                    </span>
                    <span className="block font-sans text-[10px] text-red-500/80 font-medium tracking-tight">
                      {c.role}
                    </span>
                    <span className="block font-sans text-[10px] text-zinc-400 font-light leading-snug">
                      {c.description}
                    </span>
                  </div>
                  <button
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div>
                <span className="block font-mono text-[8px] text-zinc-555 uppercase tracking-widest mb-1.5">
                  GLOBAL NEGATIVE CONSTANTS
                </span>
                <textarea
                  value={negativePrompt}
                  onChange={(e) => setNegativePrompt(e.target.value)}
                  className="w-full bg-[#07070a] border border-editorial-border/60 rounded-xl p-3 font-mono text-[10px] text-zinc-400 focus:outline-none focus:border-red-500 h-24 placeholder:text-zinc-700 resize-none uppercase"
                />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="space-y-2">
              <span className="block font-mono text-[7px] text-zinc-500 uppercase tracking-widest">
              ...
              <div className="space-y-1.5 max-h-40 overflow-y-auto custom-scrollbar">
                {[
                  ...
                  >
                    <span className="font-mono text-[9px] text-zinc-300 truncate tracking-tight">{media.name}</span>
                    <span className="font-mono text-[7px] text-red-500 bg-red-500/10 px-1.5 py-0.5 rounded uppercase">{media.type}</span>
                  </button>
                ))}
              </div>
            </div>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-6 flex flex-col min-h-0 bg-transparent">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="px-3.5 py-1.5 bg-red-650/10 hover:bg-red-600 hover:text-white border border-red-500/20 text-red-500 rounded-xl text-[10px] font-mono tracking-widest uppercase font-black transition-all"
              >
                + ADD_SCENE_CARD
              </button>
            </div>
                ...
                >
                  ...
                  <div className="flex gap-2 shrink-0 pt-4 border-t border-white/[0.02] mt-4">
                    <button
                      ...
                      className="flex-1 py-2.5 bg-zinc-900 text-zinc-400 hover:text-white border border-editorial-border rounded-xl text-[9px] font-mono tracking-widest font-bold uppercase transition-all"
                    >
                      FORGE
                    </button>
                    {sh.attachedClipUrl ? (
          ...
          <div className="p-5 bg-[#0a0a0f] border border-editorial-border rounded-[2.5rem] space-y-4">
            <div className="flex items-center justify-between border-b border-white/[0.04] pb-3">
              ...
              <span className="font-mono text-[8px] text-zinc-600 bg-white/5 border border-white/10 px-2 py-0.5 rounded uppercase">
                SYNCHRONOUS MARKERS ACTIVE
              </span>
            </div>

            <div className="space-y-2">
              <div className="flex font-mono text-[8px] text-zinc-600 tracking-widest px-4 border-b border-white/[0.02] pb-1">
              ...
              <div className="flex items-center bg-black/60 rounded-xl border border-editorial-border p-3">
                <div className="w-24 text-[10px] font-mono text-red-500 font-bold tracking-widest">VIDEO_TRK</div>
                <div className="flex-1 grid grid-cols-3 gap-2 h-8">
                  <div className="bg-red-950/20 border border-red-500/25 rounded-md flex items-center justify-center text-[9px] font-mono text-pink-400">JAX_SUNSET</div>
                  <div className="bg-red-950/10 border border-red-500/10 rounded-md flex items-center justify-center text-[9px] font-mono text-pink-400/60">NUTRI_MACRO</div>
                  <div className="bg-zinc-900 border border-zinc-800 rounded-md flex items-center justify-center text-[9px] font-mono text-zinc-600">LAB_OVERLAY</div>
                </div>
              </div>

              {/* Audio Track block */}
              <div className="flex items-center bg-black/60 rounded-xl border border-editorial-border p-3">
                <div className="w-24 text-[10px] font-mono text-pink-500 font-bold tracking-widest">AUDIO_TRK</div>
                <div className="flex-1 h-8 bg-pink-950/10 border border-pink-500/15 rounded-md flex items-center justify-center text-[9px] font-mono text-pink-400">
        ...
        <aside className="w-full lg:w-80 border-l border-editorial-border/30 bg-zinc-950/80 p-5 overflow-y-auto custom-scrollbar flex flex-col gap-6 shrink-0">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              {(["runway", "luma", "fal"] as const).map(p => (
                <button
                  ...
                  className={`py-2 px-1 rounded-xl border font-mono text-[9px] font-black uppercase tracking-wider transition-all ${
                    selectedProvider === p 
            ...
            <div className="p-4 bg-red-650/10 border border-red-500/20 rounded-2xl flex flex-col gap-2 relative">
              <div className="flex items-center gap-2 text-red-400 font-mono text-[9px] font-bold">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b border-white/[0.04] pb-2">
              ...
              <button
                ...
                className="px-2 py-1 bg-red-600 hover:bg-red-500 text-white rounded-lg text-[8px] font-mono uppercase tracking-widest"
              >
                BAKE
              </button>
            </div>
            ...
            <div className="space-y-3">
              {activeQueueJobs.length === 0 ? (
                <span className="block text-[10px] font-mono text-zinc-500 italic text-center py-4 bg-black/40 rounded-xl border border-dashed border-editorial-border-light">
                ...
                activeQueueJobs.map(job => (
                  <div key={job.id} className="p-3 bg-black/40 border border-amber-500/25 rounded-xl space-y-2">
                    <div className="flex justify-between items-center font-mono text-[8px] text-amber-500">
          ...
          <div className="p-4 bg-zinc-900/60 border border-editorial-border rounded-2xl space-y-2 shrink-0">
            <span className="block font-mono text-[8px] text-zinc-555 uppercase tracking-widest">
      ...
      <footer className="p-6 border-t border-editorial-border/30 bg-[#07070a] flex flex-col md:flex-row items-stretch justify-between gap-6 shrink-0 relative z-20">
        ...
        <div className="flex-1 flex flex-col md:flex-row gap-6">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-[9px] font-black tracking-widest text-white uppercase">
                Clip Review Room
              </span>
            </div>
            <p className="text-[10px] text-zinc-400 font-light max-w-sm leading-normal">
          ...
          <div className="flex-1 relative aspect-video max-w-sm border border-editorial-border bg-black rounded-2xl overflow-hidden shadow-lg select-none">
            ...
            />
            <div className="absolute top-2 left-2 px-2.5 py-1 bg-black/60 border border-editorial-border rounded-md font-mono text-[8px] text-red-500/80 font-bold uppercase tracking-widest">
              v1_reference.mp4
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-80 flex flex-col justify-between p-4 bg-zinc-950 border border-editorial-border rounded-[1.5rem] shrink-0 gap-3">
          <span className="block font-mono text-[8px] text-zinc-500 uppercase tracking-widest font-black">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 py-2 bg-zinc-90 w bg-zinc-900 border border-editorial-border hover:border-zinc-700 text-zinc-300 hover:text-white rounded-xl font-mono text-[9px] uppercase tracking-widest font-bold"
            >
              LINK_REF_V1
            </button>
            <button
          ...
          <div className="fixed inset-0 z-[10002] flex items-center justify-center p-4">
            ...
            >
              <div className="flex items-center gap-3 border-b border-white/[0.04] pb-4">
                ...
                <div>
                  <span className="block font-mono text-[8px] text-zinc-550 uppercase tracking-widest">
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full bg-black border border-editorial-border rounded-xl p-3 font-mono text-[10px] text-white focus:outline-none focus:border-red-500 h-24 placeholder:text-zinc-700 resize-none uppercase"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      className="w-full bg-black border border-editorial-border rounded-xl px-3 py-2.5 font-mono text-[10px] text-white focus:outline-none focus:border-red-500 uppercase"
                    >
              ...
              <div className="flex gap-3 pt-4 border-t border-white/[0.03]">
                <button
                  type="button"
                  onClick={() => setEditingShot(null)}
                  className="flex-1 py-3 bg-zinc-900 border border-editorial-border rounded-xl font-mono text-[9px] uppercase tracking-widest font-bold text-zinc-400 hover:text-white transition-all"
                >
                  CANCEL
                </button>
                <button
                  ...
                  className="flex-1 button-premium !py-3 text-[9px] font-mono uppercase tracking-widest font-black"
                >
                  COMMIT_CHANGES
                </button>
              </div>
